...
# Bot token
BOT_TOKEN = '7544620080:AAEJicPM7TCWZw4FIpSuYTfTR2kjA09oLLA'  # Replace with your bot token

# Admin ID
ADMIN_ID = 6644586902

# Admin information
ADMIN_USERNAME = "❄️pathan bhai ❄️"
ADMIN_CONTACT = "@PATHANSTOREX"
...
def get_default_buttons():
    keyboard = [
        [InlineKeyboardButton("💖 JOIN OUR CHANNEL 💖", url="https://t.me/+_hMEeQVxn0YzNDJl")],
        [InlineKeyboardButton("👻 CONTACT OWNER 👻", url="https://t.me/@PATHANSTOREX")]
    ]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = (
        ...
        "💫 The owner of this bot is ❄️pathan bhai ❄️. Contact @PATHANSTOREX."
    )
